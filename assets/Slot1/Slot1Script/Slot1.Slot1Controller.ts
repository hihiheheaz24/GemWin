...
export default class Slot1Controller extends cc.Component {
  ...
  start() {
    ...
    BroadcastReceiver.register(
      ...
      () => {
        ...
        this.mSlotLobby.updateMoney(Configs.Login.Coin);
      },
      this
    );
  ...
  private showCoins(prize) {
    ...
    App.instance.showCoins(number, this.totalWinLabel.node, this.nodeCoin, this.isSound);
  }
              ...
              this.actShowBonus(
                ...
                () => {
                  ...
                  if (!this.isTrial)
                    ...
                    this.mSlotLobby.updateMoney(currentMoney);
