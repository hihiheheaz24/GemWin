...
export class PanelMenu {
    ...
    show() {
        ...
        cc.tween(this.bg).set({ scale: 0.5, opacity: 150 }).to(0.3, { scale: 1, opacity: 255 }, { easing: cc.easing.backOut }).call(() => {
            this.animate = false;
        }).start();
    }
...
this.buttonjb.x = cc.winSize.width / 2 - 50;
        ...
        actCommingSoon(){
            App.instance.alertDialog.showMsg("Trò chơi đang xây dựng. Vui lòng đợi phiên bản mới!");
        }
        ...
        actGoToSlot5() {
            ...
            SlotNetworkClient.getInstance().checkConnect(() => {
                App.instance.showLoading(false);
                App.instance.openGame("Slot4", "Slot5");
            });
        }
